...
class PostSer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Post
        fields = ['id', 'title', 'content', 'author', 'categories', 'status', 'image', 'relative_url', 'absolute_url']
    ...
    def get_absolute_url(self, obj):  # ✅ Ensure it takes 'obj' as a parameter
        ...
        return request.build_absolute_uri(relative_url)  # ✅ Build absolute URL correctly
    ...
    def to_representation(self, instance):
        ...
        rep['categories'] = CategorySer(instance.categories, many=True, context={'request': request}).data
        return rep
